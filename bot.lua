...
local res = http.request(database.."joke.db")
 ...
 tdcli.sendText(chat_id, msg.id_, 0, 1, nil, run..'\n\n*Mshd Gang*: @Mshd_Gang', 1, 'md')
      ...
      if input:match("^[#!/][Ss]ettings$") and is_mod(msg) and groups or input:match("^[Ss]ettings$") and is_mod(msg) and groups or input:match("^تنظیمات$") and is_mod(msg) and groups then
        ...
        .."🏅 #ممنوعیت متن : ".."`"..text1.."`".."\n"
        .."🏅 ورژن 8.0 اوربیتال مشد گنگ - @Mshd_Gang"
...
if input:match("^[#!/][Jj]ove$") and is_mod(msg) or input:match("^[Jj]ove$") and is_mod(msg) or input:match("^مشد گنگ$") and is_mod(msg) then
        local text = "🏅 خداي مشد گنگ ورژن 8.0: \n"
	.." مشد گنگ رباتي قدرتمند جهت مديريت سوپرگروه: \n"
        ...
        .."🏅  ديباگ شده و قدرتمند \n"
        .."🏅  ويرايش و ارتقا: @Bot_mebot \n"
        .."🏅  کانال رسمي: @Mshd_Gang \n"
        .."🏅  پيام رسان: @Bot_mebot \n"
        .."🏅 سرور: #Hetzner \n"
        .."🏅 رم: 16Gig \n"
